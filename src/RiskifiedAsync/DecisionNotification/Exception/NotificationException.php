<?php namespace RiskifiedAsync\DecisionNotification\Exception;
/**
...
use RiskifiedAsync\Common\Exception\BaseException;

/**
 * Class NotificationException
 * Base exception for issues with the Notification Model
 * @package RiskifiedAsync\DecisionNotification\Exception
 */
