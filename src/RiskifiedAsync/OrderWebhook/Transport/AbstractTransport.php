...
abstract class AbstractTransport {
    ...
    public function __construct($signature, $url = null) {
        ...
        $this->url = ($url == null) ? RiskifiedAsync::getHost() : $url;
    ...
    */
    public function decideOrder($order) {
        $this->url = RiskifiedAsync::getHost('sync');
    ...
    public function eligible($order) {
        $this->url = RiskifiedAsync::getHost('deco');
    ...
    public function login($login) {
        $this->url = RiskifiedAsync::getHost('account');
